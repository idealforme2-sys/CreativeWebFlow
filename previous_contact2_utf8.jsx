        ...
        <section id="contact" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
                    {/* Contact Form ÔÇö Premium Glass with Particles */}
                                ...
                                {submitted ? (
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {[
                                                { name: 'name', label: 'Full Name', placeholder: 'John Doe', type: 'text', icon: '­ƒæñ' },
                                                { name: 'email', label: 'Email', placeholder: 'john@company.com', type: 'email', icon: 'Ô£ë´©Å' },
                                            ].map((field) => (
                                        ...
                                        <div className="relative">
                                            <label className="flex items-center gap-1.5 text-[10px] font-semibold text-white/50 uppercase tracking-wider mb-2">
                                                <span>­ƒÅó</span> Company <span className="text-white/20 normal-case">(optional)</span>
                                            </label>
                                            <div className="relative">
                                                <input
                                                    type="text"
                                        ...
                                        {/* Budget ÔÇö Interactive Cards */}
                                        <div>
                                            <label className="flex items-center gap-1.5 text-[10px] font-semibold text-white/50 uppercase tracking-wider mb-3">
                                                <span>­ƒÆ░</span> Budget Range
                                            </label>
                                            <div className="grid grid-cols-2 gap-2">
                                                {[
                                                    { value: '200-500', label: 'Starter', price: '$200ÔÇô$500', color: 'from-cyan-500/20 to-cyan-500/5', border: 'border-cyan-500/30', icon: '­ƒî▒' },
                                                    { value: '500-1000', label: 'Growth', price: '$500ÔÇô$1K', color: 'from-purple-500/20 to-purple-500/5', border: 'border-purple-500/30', icon: '­ƒôê' },
                                                    { value: '1000-3000', label: 'Premium', price: '$1KÔÇô$3K', color: 'from-pink-500/20 to-pink-500/5', border: 'border-pink-500/30', icon: '­ƒÆÄ' },
                                                    { value: '3000+', label: 'Enterprise', price: '$3K+', color: 'from-amber-500/20 to-amber-500/5', border: 'border-amber-500/30', icon: '­ƒÜÇ' },
                                                ].map((tier) => (
                                                    <motion.button
                                                        key={tier.value}
                                                        type="button"
                                        ...
                                        <div className="relative">
                                            <div className="flex items-center justify-between mb-2">
                                                <label className="flex items-center gap-1.5 text-[10px] font-semibold text-white/50 uppercase tracking-wider">
                                                    <span>­ƒôØ</span> Project Details <span className="text-pink-400/70">*</span>
                                                </label>
                                        ...
                                        {/* Submit Button ÔÇö Static Gradient Border + Shimmer */}
                                        <motion.div
                                        ...
                                        <p className="text-center text-[10px] text-white/25 mt-1 flex items-center justify-center gap-1.5">
                                            <span className="text-emerald-400/60">­ƒöÆ</span> Your data is safe. We never share your information.
                                        </p>
                                    </form>
                                )}
                            </div>
                    ...
                    {/* Right Column ÔÇö Info + Response Timeline */}
